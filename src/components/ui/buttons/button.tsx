    ...
    variants: {
      variant: {
        ...
        secondaryWithoutHover:
          "bg-white hover:bg-neutral-200 text-blue border border-blue flex gap-2 px-5 py-2 rounded-2xl w-full group cursor-pointer",
        delete:
          "bg-redLight text-white shadow transition-all duration-500 px-5 py-2 rounded-2xl w-full cursor-pointer",
        destructive:
